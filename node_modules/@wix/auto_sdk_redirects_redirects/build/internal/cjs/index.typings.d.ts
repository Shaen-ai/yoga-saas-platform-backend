...
interface RedirectSession {
    ...
    shortUrl?: string;
    /**
     * The base URL of the Wix page to redirect the visitor to.
     * @internal
     * @maxLength 2048
     * @readonly
     */
 ...
 */
declare function createRedirectSession(options?: CreateRedirectSessionOptions): Promise<NonNullablePaths<CreateRedirectSessionResponse, `redirectSession._id` | `redirectSession.fullUrl` | `redirectSession.urlDetails.endpoint` | `redirectSession.shortUrl`, 4>>;
